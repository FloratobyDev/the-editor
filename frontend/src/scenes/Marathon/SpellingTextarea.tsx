...
const SpellingTextarea = ({
  ...
  function onSpanClick(
    ...
    sendEvent(GameEvent.WORD_CHECK, { word: wordText });
      ...
      <div className="whitespace-pre-wrap break-words text-lg">
        {rawParagraph.split("\n").map((chunk, chunkIndex) => (
          <p key={chunkIndex} className="mb-4">
            {chunk.match(/[\w'-]+|[.,!?;:()]/g)?.map((word, index) => {
              ...
              const spanClasses = classNames(
                "py-1 font-medium text-lg inline leading-none origin-center cursor-pointer rounded-lg hover:text-green-400",
                {
                  // "text-green-300":
...
export default SpellingTextarea;
